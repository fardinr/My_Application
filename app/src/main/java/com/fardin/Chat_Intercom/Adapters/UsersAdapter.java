...
import com.fardin.Chat_Intercom.Activities.ChatScreenActivity;
...
//                          decrypting the msg here
                            ...
                            if (snapshot.child("type").getValue(String.class).equals("image")){
                                holder.binding.lastMsg.setText("Image");
                            }else {
